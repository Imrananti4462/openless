...
export const en: typeof zhCN = {
  ...
  translation: {
    ...
    howto: {
      ...
      step3: 'Press Shift once any time during recording. You can press it before speaking, mid-sentence, or right before stopping.',
      ...
      indicatorDesc: 'The moment you press Shift, a blue Translating indicator appears above the recording capsule and stays visible until insertion completes.',
      fallbackTitle: 'Safety fallbacks',
      fallbackDesc: 'When the target is Disabled, Shift does not trigger translation. If the LLM call fails, the raw transcript is inserted so nothing gets lost.',
    },
  },
  selectionAsk: {
