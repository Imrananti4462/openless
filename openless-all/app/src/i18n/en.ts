...
export const en: typeof zhCN = {
  ...
  selectionAsk: {
    ...
    title: 'Selection Ask',
    desc: 'Select text in any app, press the hotkey, ask a question by voice, and the AI answer appears in a floating panel above the recording capsule.',
    statusEnabled: 'Enabled',
    statusDisabled: 'Disabled',
    hotkey: {
      title: 'Trigger hotkey',
      desc: 'When set, selecting text in any app and pressing this combo opens a panel and starts recording. Press again to stop and generate the answer. Pick "Disabled" to turn the feature off.',
      optionDisabled: 'Disabled',
      chordWarning: '⚠️ Modifier-only chord (Cmd+Option / Ctrl+Alt): both modifiers held without any other key, then released. Fewer keys, but higher false-trigger rate than 3-key combos. Chord backend requires v1.2.9+; older builds, please pick a 3-key combo.',
    },
    history: {
      title: 'Save history',
    ...
    howto: {
      title: 'How to use',
      step1: 'Select text in any app (browser, Mail, IDE, PDF reader…).',
      step2: 'Press「{{hotkey}}」— the panel appears at the bottom of the screen and recording starts.',
      step3: 'Ask your question into the mic — e.g. "what does this mean", "explain in plain words", "how is it different from X".',
      step4: 'Press「{{hotkey}}」again to stop. The system sends your selection + voice question to the LLM.',
      step5: 'The answer renders as markdown in the panel. Press Esc or click outside to dismiss; pin (📌, top-right) to keep it open until manually closed.',
      windowTitle: 'Panel position + lifecycle',
      windowDesc: 'The panel sits 8px above the recording capsule by default, sized 380×280. Auto-closes after 30s of inactivity (unless pinned). It scrolls if the answer is long.',
